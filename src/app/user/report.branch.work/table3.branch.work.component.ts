...
@Component({
    selector: 'table-three-branch-work-com',
    template: `
        <table class="table-diagram" style="direction:rtl;">
            <thead>
                <tr>
                    <th class="th-diagram center th-header-diagram">#</th>
                    <th class="th-diagram">شرح جدول 3</th>
                    <th class="th-diagram center" style="width:12%;">مانده یا گردش حسابها</th>
                    <th class="th-diagram center" style="width:12%;">تعداد در پایان سال</th>
                </tr>
            </thead>
...
export class TableThreeBranchWorkComponent {
    fldcode_data: any[] = [];
    //---------------------------------------------------
